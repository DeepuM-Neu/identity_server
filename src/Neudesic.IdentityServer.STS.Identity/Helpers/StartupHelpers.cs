...
using Neudesic.IdentityServer.STS.Identity.Configuration;
using Neudesic.IdentityServer.STS.Identity.Configuration.ApplicationParts;
using Neudesic.IdentityServer.STS.Identity.Configuration.Constants;
using Neudesic.IdentityServer.STS.Identity.Configuration.Interfaces;
using Neudesic.IdentityServer.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Neudesic.IdentityServer.STS.Identity.Helpers
{
