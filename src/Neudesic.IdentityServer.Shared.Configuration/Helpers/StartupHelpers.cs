...
using SendGrid;
using Neudesic.IdentityServer.Shared.Configuration.Configuration.Common;
using Neudesic.IdentityServer.Shared.Configuration.Configuration.Email;
using Neudesic.IdentityServer.Shared.Configuration.Email;

namespace Neudesic.IdentityServer.Shared.Configuration.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TDbContext : DbContext, IDataProtectionKeyContext
        {
            var dataProtectionBuilder = services.AddDataProtection()
                .SetApplicationName("Neudesic.IdentityServer")
