...
using Neudesic.IdentityServer.Admin.BusinessLogic.Services;
...
using Neudesic.IdentityServer.Admin.UI.Configuration.ApplicationParts;
using Neudesic.IdentityServer.Admin.UI.Configuration.Constants;
...
using Neudesic.IdentityServer.Admin.EntityFramework.Repositories;
using Neudesic.IdentityServer.Admin.EntityFramework.Repositories.Interfaces;
using Neudesic.IdentityServer.Admin.UI.ExceptionHandling;
using Neudesic.IdentityServer.Admin.UI.Helpers.Localization;
using System;
...
using Neudesic.IdentityServer.Admin.UI.Middlewares;
using Microsoft.AspNetCore.Authorization;
using Neudesic.IdentityServer.Admin.EntityFramework.Configuration.Configuration;
using Neudesic.IdentityServer.Admin.EntityFramework.Configuration.MySql;
using Neudesic.IdentityServer.Admin.EntityFramework.Configuration.PostgreSQL;
using Neudesic.IdentityServer.Admin.EntityFramework.Configuration.SqlServer;
using Neudesic.IdentityServer.Shared.Configuration.Authentication;

namespace Neudesic.IdentityServer.Admin.UI.Helpers
{
